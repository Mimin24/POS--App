    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Edit {{$product->name}}</h2>
                    ...
                    <form action="{{ route('products.update', $product) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mt-4">
                                <label class="form-label w-100">Popular</label>
                                <div class="selectgroup selectgroup-pills">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="popular" value="1" class="selectgroup-input"
                                            {{ $product->popular == 1 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">Yes</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="popular" value="0" class="selectgroup-input"
                                            {{ $product->popular == 0 ? 'checked' : '' }}>
